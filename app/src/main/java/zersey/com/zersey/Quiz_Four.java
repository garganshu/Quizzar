...
public class Quiz_Four extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz__four);
        setTitle("QUIZ FOUR");
        arrayList = new ArrayList<String>();
        builder = new AlertDialog.Builder(this);


        rq1 = (RadioGroup) findViewById(R.id.RGQ4_q1);
        rq2 = (RadioGroup) findViewById(R.id.RGQ4_q2);
        rq3 = (RadioGroup) findViewById(R.id.RGQ4_q3);

        tq1 = (TextView) findViewById(R.id.Quiz4_ques1);
        tq2 = (TextView) findViewById(R.id.Quiz4_ques2);
        tq3 = (TextView) findViewById(R.id.Quiz4_ques3);
    ...
    public void submit_quiz_four(View view){
    ...
    public void database_fetch(){
        ...
        mCursor2 = sql_db.rawQuery("SELECT * FROM "
                + dbhelper.TABLE_Quiz + " WHERE " + dbhelper.KEY_Type + " = 'Quiz4'", null);
