...
public class Quiz_Two extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz__two);
        setTitle("QUIZ TWO");
        arrayList = new ArrayList<String>();
        builder = new AlertDialog.Builder(this);


        rq1 = (RadioGroup) findViewById(R.id.RGQ2_q1);
        rq2 = (RadioGroup) findViewById(R.id.RGQ2_q2);
        rq3 = (RadioGroup) findViewById(R.id.RGQ2_q3);

        tq1 = (TextView) findViewById(R.id.Quiz2_ques1);
        tq2 = (TextView) findViewById(R.id.Quiz2_ques2);
        tq3 = (TextView) findViewById(R.id.Quiz2_ques3);
    ...
    public void submit_quiz_two(View view){
    ...
    public void database_fetch(){
        ...
        mCursor2 = sql_db.rawQuery("SELECT * FROM "
                + dbhelper.TABLE_Quiz + " WHERE " + dbhelper.KEY_Type + " = 'Quiz2'", null);
